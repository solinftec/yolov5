...
RUN pip install --no-cache -r requirements.txt coremltools onnx gsutil notebook wandb>=0.12.2 mlflow==2.1.1
RUN pip install --no-cache -U torch torchvision numpy==1.22.4
